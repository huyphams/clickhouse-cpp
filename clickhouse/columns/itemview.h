...
public:
    ...
    auto get() const {
        ...
        if constexpr (std::is_same_v<std::string_view, ValueType> || std::is_same_v<std::string, ValueType>) {
            return data;
        } else if constexpr (std::is_fundamental_v<ValueType> || std::is_same_v<Int128, ValueType> || std::is_same_v<UInt128, ValueType> || std::is_same_v<Int256, ValueType> || std::is_same_v<UInt256, ValueType>) {
